...
[Source.](./rooms/examples/eg001_create_room_with_data/controller.py)
...
[Source.](./rooms/examples/eg002_create_room_with_template/controller.py)
This example creates a new room using a template.
1. **Create a room with Data.**
[Source.](./rooms/examples/eg003_export_data_from_room/controller.py)
This example exports all the available data from a specific room in your DocuSign Rooms account.
1. **Add forms to a room.**
[Source.](./rooms/examples/eg004_add_forms_to_room/controller.py)
...
[Source.](./rooms/examples/eg005_get_rooms_with_filters/controller.py)
1. **Create an external form fillable session.**
[Source.](./rooms/examples/eg006_create_external_form_fill_session/controller.py)
