...
from .eg022_kba_authentication import Eg022KBAAuthenticationController
...
def get_view():
    ...
    return render_template(
        ...
        source_file=path.basename(path.dirname(__file__)) + "/eg022_kba_authentication.py",
        source_url=DS_CONFIG["github_example_url"] + path.basename(path.dirname(__file__)) + "/eg022_kba_authentication.py",
