...
def add_doc_template():
    ...
    if "template_id" in session:
        ...
        return render_template(
            ...
            template_ok=False,
            source_file=path.basename(path.dirname(__file__)) + "/eg013_add_doc_to_template.py",
            source_url=DS_CONFIG["github_example_url"] + path.basename(path.dirname(__file__)) + "/eg013_add_doc_to_template.py",
